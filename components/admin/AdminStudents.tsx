        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-xl shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-5">
              ...
              {/* Courses */}
              <div>
                <h4 className="font-semibold text-alivos-dark mb-3">Cursos activos</h4>
              ...
              {/* Purchases */}
              <div>
                <h4 className="font-semibold text-alivos-dark mb-3">Compras</h4>
                <div className="space-y-2">
                  {purchases
                    ...
                    .map((p) => (
                      <div key={p.id} className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                        ...
                        <span className="text-sm font-bold">${p.amount.toLocaleString("es-AR")}</span>
              ...
              {/* Tasks */}
              <div>
                <h4 className="font-semibold text-alivos-dark mb-3">Tareas</h4>
                <div className="space-y-2">
                  {taskSubmissions
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50">
                ...
                <th className="text-left px-5 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider hidden md:table-cell">Teléfono</th>
                <th className="text-left px-5 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider hidden sm:table-cell">Cursos</th>
                ...
                <th className="text-left px-5 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider hidden lg:table-cell">Último acceso</th>
            ...
            <tbody className="divide-y divide-slate-50">
              {filtered.map((student) => (
                <tr key={student.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="px-5 py-4 text-slate-600 hidden md:table-cell">{student.phone}</td>
                  <td className="px-5 py-4 hidden sm:table-cell">
                    <span className="text-slate-600">{student.courses.length} curso{student.courses.length !== 1 ? "s" : ""}</span>
                  </td>
                  ...
                  <td className="px-5 py-4 text-slate-500 text-xs hidden lg:table-cell">{student.lastAccess}</td>
                  <td className="px-5 py-4">
