          ...
          {course.longDescription && (
            <div className="border-b border-slate-100 shrink-0">
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-2.5 text-xs font-semibold text-slate-500 hover:text-brand-700 hover:bg-slate-50 transition-colors"
              >
              ...
              {showAbout && (
                <p className="px-4 pb-3 text-xs text-slate-600 leading-relaxed whitespace-pre-line">
                  {course.longDescription}
                </p>
              )}
            </div>
